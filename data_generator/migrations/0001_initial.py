    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SN102', models.IntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CLD02', models.CharField(blank=True, max_length=50)),
                ('CLD03', models.CharField(blank=True, max_length=50)),
                ('Hierarchial', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='data_generator.Data_Generator_Hierarchial')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='data_generator_loads',
            name='PRIM',
        ...
        migrations.AddField(
            model_name='data_generator_cld',
            name='Hierarchial',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='data_generator.Data_Generator_Hierarchial'),
        ),
        migrations.AddField(
            model_name='data_generator_cld',
            name='PRIM',
