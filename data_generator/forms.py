...
class ASN_Heading(forms.ModelForm):
	...
	PREFIX_CLIENT = forms.CharField(required=False, label='Client', widget=forms.TextInput(attrs={'class': 'form-control'}))
	PREFIX_NAME = forms.CharField(required=False, label='Client', widget=forms.TextInput(attrs={'class': 'form-control'}))
	CLIENT = forms.CharField(required=False, label='Client', widget=forms.TextInput(attrs={'class': 'form-control'}))
	NAME = forms.CharField(required=False, label='Client', widget=forms.TextInput(attrs={'class': 'form-control'}))
