...
class Data_Generator_Name(models.Model):
	PRIM = models.ForeignKey(Data_Generator_Master, on_delete= models.CASCADE, blank = True, default = 1 )
...
class Data_Generator_Order(models.Model):
	PRIM = models.ForeignKey(Data_Generator_Hierarchial, on_delete= models.CASCADE, blank = True, default = 1 )
	LIN01 = models.CharField(blank = True, max_length = 50)
	LIN02 = models.CharField(blank = True, max_length = 50)
	LIN03 = models.CharField(blank = True, max_length = 50)
	SN101 = models.CharField(blank = True, max_length = 50)
